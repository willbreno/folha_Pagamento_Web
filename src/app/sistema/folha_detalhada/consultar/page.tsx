...
import { ListDataFolhaDetalhada } from "./components/ListDataFolhaDetalhada/ListDataFolhaDetalhada";
...
export default function Page() {
    ...
    return (
        <div className="w-full h-fit flex flex-col gap-6">
            ...
            <h1 className="font-extrabold text-4xl">Gerenciamento de Folha Detalhada</h1>
